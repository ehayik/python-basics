...
create variables with Boolean values. See comments for further instructions.
"""
...
counts for the top four countries in the past three Olympics. Assign 
the value of Great Britain’s gold medal count from the London Olympics 
to the variable london_gold. Use indexing. Do not hardcode.
"""
...
for names in athletes:
    for name in names:
        t.append(name) if "t" in name else other.append(name)